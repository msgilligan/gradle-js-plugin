...
- *(Optional)* closure.compilerOptions = [CompilerOptions](http://closure-compiler.googlecode.com/svn/trunk/javadoc/com/google/javascript/jscomp/CompilerOptions.html) object
